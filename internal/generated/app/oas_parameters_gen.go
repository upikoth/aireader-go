...
// V1GetVoicesParams is parameters of V1GetVoices operation.
type V1GetVoicesParams struct {
	// Максимальное количество элементов в ответе.
	Limit OptInt
	// Отступ, начиная с которого нужно возвращать элементы.
	Offset OptInt
...
func unpackV1GetVoicesParams(packed middleware.Parameters) (params V1GetVoicesParams) {
	{
		key := middleware.ParameterKey{
			Name: "limit",
			In:   "query",
...
func decodeV1GetVoicesParams(args [0]string, argsEscaped bool, r *http.Request) (params V1GetVoicesParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	// Set default value for query: limit.
	{
		val := int(10)
